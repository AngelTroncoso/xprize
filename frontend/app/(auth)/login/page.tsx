        ...
        <div className="glass-panel rounded-2xl p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#020208] px-4 text-gray-500">o continúa con</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 glass-panel px-4 py-3 rounded-xl text-sm font-semibold hover:border-indigo-500/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
